...
template<typename NewType> struct Append<NullType, NewType> {
...
template<typename Head, typename Tail, typename NewType> struct Append<TypeList<Head, Tail>, NewType>{
